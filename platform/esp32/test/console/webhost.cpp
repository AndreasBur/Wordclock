...
/* No header ever arrives here: this process serves the page for looking at, and a password
   would only get in the way of that. */
esp_err_t httpd_req_get_hdr_value_str(httpd_req_t*, const char*, char*, size_t) { return ESP_FAIL; }
