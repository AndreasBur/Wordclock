...
} DisplayCharacterCharactersType;
...
class DisplayCharacter
{
  ...
  public:
	...
	// methods
	void setCharacter(DisplayCharacterCharactersType Character);
	stdReturnType getCharacter(byte Row, byte Column, char* Char);
	stdReturnType getCharacter(byte Index, char* Char);
};
