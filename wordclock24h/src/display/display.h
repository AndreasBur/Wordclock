...
/*-------------------------------------------------------------------------------------------------------------------------------------------
 * overlay intervals
 * don't change indices, they are used for position in EEPROM!
 *-------------------------------------------------------------------------------------------------------------------------------------------
 */
#define OVERLAY_HEART_IDX                           0                   // heart icon
#define OVERLAY_XMAS_TREE_IDX                       1                   // xmas tree icon
#define OVERLAY_DATE_IDX                            2                   // date
#define OVERLAY_FIREWORKS_IDX                       3                   // fireworks icon
#define OVERLAY_TEMPERATURE_IDX                     4                   // temperature

#define MAX_OVERLAYS                                5                   // number of overlays

/*-------------------------------------------------------------------------------------------------------------------------------------------
 * icons
 *-------------------------------------------------------------------------------------------------------------------------------------------
 */
#define ICON_HEART_ICON_IDX                         0                   // heart icon
#define ICON_XMAS_TREE_ICON                         1                   // xmas tree icon
#define ICON_FIREWORKS_ICON                         2                   // fireworks icon (with animation)

#define MAX_ICONS                                   3                   // define more icons here

typedef struct
{
    uint8_t intervals[MAX_OVERLAYS];                                    // this will be stored in EEPROM
    uint8_t icon_map[MAX_OVERLAYS];                                     // index values of icons, fixed
} OVERLAYS;
...
extern void             display_set_overlay_interval (uint_fast8_t, uint_fast8_t);
