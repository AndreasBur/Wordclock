...
volatile uint8_t* const port_to_mode_PGM[] = {
  NOT_A_PORT,                  // 0
  &PORTA_DIR,       // PA
...
volatile uint8_t* const PROGMEM port_to_output_PGM[] = {
  NOT_A_PORT,                  // 0
  &PORTA_OUT,       // PA
  NOT_A_PORT,                  // 2  [E series has no 'port B'
  &PORTC_OUT,       // PC
...
volatile uint8_t* const PROGMEM port_to_input_PGM[] = {
  NOT_A_PORT,                  // 0
  &PORTA_IN,        // PA
  NOT_A_PORT,                  // 2  [E series has no 'port B'
  &PORTC_IN,        // PC
...
volatile uint8_t* const PROGMEM digital_pin_to_control_PGM[] = {
#ifndef DIGITAL_IO_PIN_SHIFT
  &PORTD_PIN0CTRL,  // PD 0 ** 0 **
  &PORTD_PIN1CTRL,  // PD 1 ** 1 **
#endif // DIGITAL_IO_PIN_SHIFT
// subtract 2 from the digital pin number if DIGITAL_IO_PIN_SHIFT is defined
  &PORTD_PIN2CTRL,  // PD 2 ** 2 ** USARTD_RX     ASYNC
  &PORTD_PIN3CTRL,  // PD 3 ** 3 ** USARTD_TX
#ifdef DIGITAL_IO_PIN_SHIFT
  &PORTD_PIN0CTRL,  // PD 0 ** 8 ** 
#endif // DIGITAL_IO_PIN_SHIFT
  &PORTD_PIN4CTRL,  // PD 4 ** 4 **
  &PORTD_PIN5CTRL,  // PD 5 ** 5 **
  &PORTD_PIN6CTRL,  // PD 6 ** 6 **
  &PORTD_PIN7CTRL,  // PD 7 ** 7 **
#ifdef DIGITAL_IO_PIN_SHIFT
  &PORTD_PIN1CTRL,  // PD 1 ** 9 ** PC 0,1 must be used for TWI
#else // no pin shifting
  &PORTC_PIN0CTRL,  // PC 0 ** 8 ** SDA
  &PORTC_PIN1CTRL,  // PC 1 ** 9 ** SCL
#endif // DIGITAL_IO_PIN_SHIFT
  &PORTC_PIN2CTRL,  // PC 2 ** 10 **              ASYNC
  &PORTC_PIN3CTRL,  // PC 3 ** 11 **
  &PORTC_PIN4CTRL,  // PC 4 ** 12 ** SPI_SS

#ifdef DIGITAL_IO_PIN_SHIFT
  &PORTC_PIN7CTRL,  // PC 7 ** 15 ** SPI_MOSI
#else // DIGITAL_IO_PIN_SHIFT
  &PORTC_PIN5CTRL,  // PC 5 ** 13 ** SPI_SCK
#endif // DIGITAL_IO_PIN_SHIFT
  &PORTC_PIN6CTRL,  // PC 6 ** 14 ** SPI_MISO
#ifdef DIGITAL_IO_PIN_SHIFT
  &PORTC_PIN5CTRL,  // PC 5 ** 13 ** SPI_SCK
#else // DIGITAL_IO_PIN_SHIFT
  &PORTC_PIN7CTRL,  // PC 7 ** 15 ** SPI_MOSI
  ...
  &PORTR_PIN0CTRL,  // PR 0 ** 16 **
  &PORTR_PIN1CTRL,  // PR 1 ** 17 ** default LED
#ifdef DIGITAL_IO_PIN_SHIFT
  &PORTC_PIN0CTRL,  // PC 0 ** the new 16 ** SDA
  &PORTC_PIN1CTRL,  // PC 1 ** the new 17 ** SCL
#endif // DIGITAL_IO_PIN_SHIFT
#ifndef USE_AREF
  &PORTA_PIN0CTRL,  // PA 0 ** 18 ** A0           AREF (when USE_AREF is defined, and then it won't be mapped)
#endif // USE_AREF
  &PORTA_PIN1CTRL,  // PA 1 ** 19 ** A1
  &PORTA_PIN2CTRL,  // PA 2 ** 20 ** A2           ASYNC
  &PORTA_PIN3CTRL,  // PA 3 ** 21 ** A3
  &PORTA_PIN4CTRL,  // PA 4 ** 22 ** A4
  &PORTA_PIN5CTRL,  // PA 5 ** 23 ** A5
  &PORTA_PIN6CTRL,  // PA 6 ** 24 ** A6
  &PORTA_PIN7CTRL,  // PA 7 ** 25 ** A7
};
