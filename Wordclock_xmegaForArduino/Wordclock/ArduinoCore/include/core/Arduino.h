...
extern volatile uint8_t* const PROGMEM port_to_mode_PGM[];
extern volatile uint8_t* const PROGMEM port_to_input_PGM[];
extern volatile uint8_t* const PROGMEM port_to_output_PGM[];
extern volatile uint8_t* const PROGMEM digital_pin_to_control_PGM[];
