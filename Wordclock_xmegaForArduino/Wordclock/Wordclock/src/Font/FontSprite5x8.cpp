...
******************************************************************************************************************************************************/
const FontSprite5x8::FontTableElementType FontSprite5x8::FontTable[] PROGMEM
{
    ...
    {4, B01111111, B01000001, B01000001, B01111111, B00000000}, // 
    {4, B01111100, B00010011, B00010011, B01111100, B00000000}, // Ä
    {4, B00111100, B01000011, B01000011, B00111100, B00000000}, // Ö
    {4, B00111110, B01000001, B01000001, B00111110, B00000000}, // Ü
    {4, B00100000, B01010110, B01010110, B01111000, B00000000}, // ä
    {4, B00111000, B01000110, B01000110, B00111000, B00000000}, // ö
    {4, B00111100, B01000010, B01000010, B01111100, B00000000}, // ü
};
 ...
 *  \return         -
******************************************************************************************************************************************************/
stdReturnType FontSprite5x8::getChar(byte Index, CharType& Char)
{
    if(Index < getNumberOfFontTableElements()) {
        Char = getFontTableElement(Index);
        return E_OK;
    } else {
        return E_NOT_OK;
    }
 ...
 *  \return         -
******************************************************************************************************************************************************/
inline byte FontSprite5x8::getNumberOfFontTableElements()
{
