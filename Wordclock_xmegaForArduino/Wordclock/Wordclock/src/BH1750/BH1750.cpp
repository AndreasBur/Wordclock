...
{
    Mode = MODE_NONE;
    Illuminance = BH1750_ILLUMINANCE_MIN_LX_VALUE;
    CalibrationValues.MinValue = BH1750_ILLUMINANCE_MIN_LX_VALUE;
    CalibrationValues.MaxValue = BH1750_ILLUMINANCE_MAX_LX_VALUE;
} /* BH1750 */
